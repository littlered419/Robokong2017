	...
	void OperatorControl() override {
		...
		X = 1;
			...
			case 1:
				...
				myRobot.TankDrive(gamePad.GetRawAxis(5) / -1, gamePad.GetRawAxis(1) / -1);
			...
			case 1:
				//Set GearL to be at starting angle 0.35 and GearR to be and angle 0.6 (has been calibrated).
				//5
				GearL->Set(0.35);
